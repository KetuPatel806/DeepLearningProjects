import os
import sys
import shutil ## shutil.copy and shutil.move is mainly used for the copying and moving the files and used for the directory switching
...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
            ...
            try:
                ...
                logging.info(f"Data Vaklidation Artifact: {DataValidationArtifact}")
